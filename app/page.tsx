      ...
      <Tabs defaultValue="dashboard" className="w-full">
        <div className="bg-slate-800 border-b border-slate-700 px-6 py-4">
          <TabsList className="bg-slate-700">
            ...
            <TabsTrigger value="patrol" className="data-[state=active]:bg-slate-600">
              Patrol Tracker
            </TabsTrigger>
            <TabsTrigger value="mobile" className="data-[state=active]:bg-slate-600">
              Citizen Mobile App
            </TabsTrigger>
            <TabsTrigger value="pwa" className="data-[state=active]:bg-slate-600">
              PWA Mobile
            </TabsTrigger>
            <TabsTrigger value="accessibility" className="data-[state=active]:bg-slate-600">
        ...
        <TabsContent value="accessibility" className="m-0">
          <div className="p-6 max-w-4xl mx-auto">
            <div className="mb-6">
              <h1 className="text-2xl font-bold text-white mb-2">Accessibility Settings</h1>
              <p className="text-slate-400">
                Customize the interface for better accessibility and color vision support
              </p>
            </div>
